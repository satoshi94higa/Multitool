...
const INITIAL_LAYOUTS = {
  lg: [
    { i: 'text-processor', x: 0, y: 0, w: 1, h: 10 },
    { i: 'screenwriter', x: 1, y: 0, w: 1, h: 16 },
    { i: 'journalist', x: 0, y: 10, w: 1, h: 12 },
    { i: 'social', x: 1, y: 16, w: 1, h: 10 },
    { i: 'brainstormer', x: 0, y: 22, w: 1, h: 11 },
    { i: 'qr-generator', x: 0, y: 33, w: 1, h: 10 },
    { i: 'percentage', x: 1, y: 26, w: 1, h: 6 },
    { i: 'fuel', x: 1, y: 32, w: 1, h: 6 },
    { i: 'director', x: 0, y: 43, w: 2, h: 14 },
  ],
  md: [
    { i: 'text-processor', x: 0, y: 0, w: 1, h: 10 },
    { i: 'screenwriter', x: 1, y: 0, w: 1, h: 16 },
  ...
  sm: [
    { i: 'text-processor', x: 0, y: 0, w: 1, h: 10 },
    { i: 'screenwriter', x: 0, y: 10, w: 1, h: 16 },
    { i: 'director', x: 0, y: 26, w: 1, h: 14 },
    { i: 'journalist', x: 0, y: 40, w: 1, h: 12 },
    { i: 'brainstormer', x: 0, y: 52, w: 1, h: 11 },
    { i: 'social', x: 0, y: 63, w: 1, h: 10 },
    { i: 'qr-generator', x: 0, y: 73, w: 1, h: 10 },
    { i: 'percentage', x: 0, y: 83, w: 1, h: 6 },
    { i: 'fuel', x: 0, y: 89, w: 1, h: 6 },
  ]
};
